...
class SelectFriendForCallScreen extends StatelessWidget {
  const SelectFriendForCallScreen({super.key});

  // Helper to chunk UID list into chunks of 10
  ...
  // Fetch friend data based on chunked UID lists
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                leading: Icon(Icons.call, color: AppColors.deepCherry, size: 24.r),
                title: Text('Voice Call', style: TextStyle(fontSize: 16.sp)),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
              ...
              ListTile(
                leading: Icon(Icons.videocam, color: AppColors.deepCherry, size: 24.r),
              ...
              child: FutureBuilder<DocumentSnapshot>(
                ...
                builder: (context, userSnapshot) {
                  ...
                  final List<String> friendIds =
                      friendIdsRaw.map((id) => id.toString()).toList();
